...
const server = gateway({
  ...
  routes: [
    ...
    {
      prefix: '/api/v1/medical-orders',
      target: `${medicalOrdersServiceUrl}`,
      prefixRewrite: '/api/v1/medical-orders',
    },
    {
      prefix: '/api/v1/medical-orders/',
      target: `${medicalOrdersServiceUrl}`,
    ...
    {
      prefix: '/api/v1/exam-templates',
      target: `${medicalOrdersServiceUrl}`,
      prefixRewrite: '/api/v1/exam-templates',
    },
    {
      prefix: '/api/v1/exam-templates/',
      target: `${medicalOrdersServiceUrl}`,
